<div class="row padding-1 p-1">
    ...
    <div class="col-md-4">
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="codigoTransaccion" class="form-control @error('codigoTransaccion') is-invalid @enderror" value="{{ old('codigoTransaccion', session('user')->maxCodigoRegistro()) }}" id="codigo_transaccion" disabled>
...
<div class="row padding-1 p-1">
    <div class="col-md-4">
        <div class="form-group mb-2 mb20">
            ...
            <input type="number" step="0.00" name="debe" class="form-control @error('debe') is-invalid @enderror" value="{{ old('debe', $tblRegistroDiario?->debe) }}" id="debe" placeholder="Debe">
    ...
    <div class="col-md-4">
        <div class="form-group mb-2 mb20">
            ...
            <input type="number" step="0.00" name="haber" class="form-control @error('haber') is-invalid @enderror" value="{{ old('haber', $tblRegistroDiario?->haber) }}" id="haber" placeholder="Haber">
